describe("Testing Purchase History", function() {
    ...
    var purchaseHistoryServiceMock = jasmine.createSpyObj(
        "PurchaseHistoryService", ["GetAll", "GetByUPC", "GetByDates"]
    );
    ...
    describe("testing transition resolve", function() {
        ...
        it("will successfully redirect to transaction page", function() {
            $httpBackend
                .whenGET("/partials/transactionsviews/NewTransaction")
                .respond(200, {});
            goTo("/Transaction");
        });
    });
    ...
    describe("when navigating to /PurchaseHistory", function() {
        ...
        it("will display page", function() {
            $httpBackend
                .whenGET("/partials/transactionsviews/purchasehistory")
                .respond(200, {});
        ...
        describe("testing service", function() {
            ...
            it("will return data for GetByUPC", function() {
                ...
                $scope.$apply();
                expect(
                    $filter("filter")(ret, { upc: "123456789013" }, true)[0].item
                ).toEqual("milk");
            });
            it("will return data for GetByDates", function() {
                ...
                $scope.$apply();
                expect(
                    $filter("filter")(ret, { transdate: "7/25/2018" }, true)[0].item
                ).toEqual("soap");
            });
        });
        ...
        describe("testing PurchaseHistory controller", function() {
            it("should return correct values from variables and functions", function() {
                ...
                expect(PurchaseHistoryController.formatDate(data)[0].transdate).toEqual(
                    "July 23, 2018"
                );
            });
        });
